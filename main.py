...
def handle_dialog(res, req):
    ...
    if sessionStorage[user_id]['first_name'] is None:
        ...
        if first_name is None:
            ...
            res['response'][
                'text'] = f"Привет, {sessionStorage[user_id]['first_name']}! Я могу сказать в какой стране город или сказать расстояние между городами!"
            return
    ...
    if len(cities) == 0:
        ...
        res['response']['text'] = f"{sessionStorage[user_id]['first_name']}, вы написали слишком много городов!"
